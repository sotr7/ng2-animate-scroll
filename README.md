[![Join the chat at https://gitter.im/sotr7/sotr7](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/sotr7/sotr7?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
## Demo
You can check out the demo [here](https://sotr7.github.io/ng2-animate-scroll/).
...
import {Ng2AnimateScrollModule} from 'ng2-animate-scroll'; // <-- import the module
import {MyComponent} from './my.component';

@NgModule({
    imports: [BrowserModule, Ng2AnimateScrollModule], // <-- include it in your app module
...
### Define the animations and scroll options
```TypeScript
// my.component.ts
@Component({
